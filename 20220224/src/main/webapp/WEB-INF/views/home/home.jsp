...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<li class="nav-item"><a class="nav-link collapsed" href="loginForm.do">
					<i class="fas fa-fw fa-cog"></i> <span>Login</span></a>
			</li>

			<!-- Nav Item - Utilities Collapse Menu -->
			<li class="nav-item"><a class="nav-link collapsed" href="memberList.do">
					<i class="fas fa-fw fa-wrench"></i> <span>Members</span></a>
			</li>
						...
						<c:if test="${not empty id }">
							...
							<li class="nav-item dropdown no-arrow"><a class="nav-link dropdown-toggle" href="#"
									...
									aria-expanded="false"> <span
										class="mr-2 d-none d-lg-inline text-gray-600 small">${name}</span> <img
